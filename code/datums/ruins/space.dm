...
/datum/map_template/ruin/space/old_ai_sat
	id = "oldAIsat"
	suffix = "oldAIsat.dmm"
	name = "Space-Ruin Abandoned AI Satellite"
	description = "With the sheer quantity of research done by Nanotrasen, the Company sometimes finds it cheaper to just scuttle obsolete projects and \
